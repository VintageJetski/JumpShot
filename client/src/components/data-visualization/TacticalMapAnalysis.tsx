...
const INFERNO_MAP_CONFIG = {
  ...
  // Tactical zones positioned to match visual Inferno map layout based on screenshot analysis
  zones: {
    'B_SITE': { 
      bounds: { minX: -1400, maxX: -600, minY: -400, maxY: 400 },
      color: '#8b5cf6', name: 'B Site', priority: 'high'
    },
    'T_RAMP': { 
      bounds: { minX: -1000, maxX: -400, minY: -600, maxY: -200 },
      color: '#ef4444', name: 'T Ramp', priority: 'medium'
    },
    'BANANA': { 
      bounds: { minX: -1200, maxX: -400, minY: 600, maxY: 1400 },
      color: '#f97316', name: 'Banana', priority: 'medium'
    },
    'APARTMENTS': { 
      bounds: { minX: -200, maxX: 800, minY: 0, maxY: 800 },
      color: '#3b82f6', name: 'Apartments', priority: 'medium'
    },
    'CONNECTOR': { 
      bounds: { minX: -400, maxX: 400, minY: 1000, maxY: 1800 },
      color: '#9333ea', name: 'Connector', priority: 'medium'
    },
    'MIDDLE': { 
      bounds: { minX: 0, maxX: 800, minY: 1200, maxY: 2000 },
      color: '#eab308', name: 'Middle', priority: 'high'
    },
    'ARCH_SIDE': { 
      bounds: { minX: 400, maxX: 1200, minY: 1600, maxY: 2400 },
      color: '#06b6d4', name: 'Arch Side', priority: 'medium'
    },
    'LONG_HALL': { 
      bounds: { minX: 800, maxX: 1600, minY: 0, maxY: 800 },
    ...
    'A_SITE': { 
      bounds: { minX: 1600, maxX: 2400, minY: 1400, maxY: 2200 },
      color: '#22c55e', name: 'A Site', priority: 'high'
    },
    'SPEEDWAY': { 
      bounds: { minX: 1400, maxX: 2200, minY: 2000, maxY: 2800 },
      color: '#06b6d4', name: 'Speedway', priority: 'medium'
    },
    'CT_SPAWN': { 
      bounds: { minX: 2200, maxX: 2644, minY: 1800, maxY: 2400 },
      color: '#10b981', name: 'CT Spawn', priority: 'low'
    },
    'T_SPAWN': { 
      bounds: { minX: -1675, maxX: -1200, minY: 2800, maxY: 3200 },
